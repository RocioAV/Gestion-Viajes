...
*/
-- DropForeignKey
ALTER TABLE "Trip" DROP CONSTRAINT "Trip_arrival_operator_id_fkey";

-- DropForeignKey
ALTER TABLE "Trip" DROP CONSTRAINT "Trip_departure_operator_id_fkey";

-- DropForeignKey
ALTER TABLE "Trip" DROP CONSTRAINT "Trip_vehicle_id_fkey";
